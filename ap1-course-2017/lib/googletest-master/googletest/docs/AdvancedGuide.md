...
An event handler function can examine the argument it receives to findDriver
...
ready to tackle more complex testing objects. If you want to dive even deeper, you
