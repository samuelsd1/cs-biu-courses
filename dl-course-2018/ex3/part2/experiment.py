...
def main():
    # change here the language to try different languages.
    # you can find all languages in Language.py
    lang = Language.PrimeBinary(int(1e8))
    print lang.good_sample()
    print lang.bad_sample()
    print 'Generating train...',
    train = Language.generate_train(lang, 1000)
    print 'Done\nGenerating dev...',
    dev = Language.generate_train(lang, 100)
    print 'Done'
    b = AcceptorDeployer(lang.vocab, lang.max_word_len, 100, 2)
